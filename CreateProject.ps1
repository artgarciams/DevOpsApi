...
Get-SecuritybyGroupByNamespace -userParams $userParameters  -rawDataDump "Rawdata-10-28-2.txt"  -getAllProjects "True" -outFile "Get-SecuritybyGroupByNamespace-10-28-2.txt" 
